...
test.each([
  ...
  [
    "admin header x-hdstmevents-adminkey",
    new Request("http://sub.domain.example", {
      headers: { "x-hdstmevents-adminkey": "testkey" },
    }),
    "testkey",
    ["read", "admin"],
  ],
  ...
  [
    "bad header x-hdstmevents-adminkey",
    new Request("http://sub.domain.example", {
      headers: { "x-hdstmevents-adminkey": "badkey" },
    }),
    "testkey",
    ["read"],
  ],
  ...
  [
    "noenv header x-hdstmevents-adminkey",
    new Request("http://sub.domain.example", {
      headers: { "x-hdstmevents-adminkey": "" },
    }),
    "",
    ["read"],
  ],
